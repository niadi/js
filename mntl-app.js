			...
			$.each(responses, function(i, response){
				$.each(response.feed.entry, function(i, post){
					...
					if (post.media$thumbnail) {
						...
						data.image = 'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjhlzrDBL6kAIclFYFeRx7cF3w-X1qqkcjEP_io-XVCIPhWq0edt2PCZFd0-0XlZANlmpk_UkS3svsmZVthApDAx5PWJM9xq1ebAsg4dhuf-izxG48jxSpfe6NLCD5ylvThifZl0_NQeNYxlv3r4YppLhiOEFTkXAe1LfjbBaJ498m6-1DSVvJ6mlyKEA/s300/Screenshot_2018-02-13-15-42-38.jpg';
					}
